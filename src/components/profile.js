...
export default function profile({ name = "John Doe", imgsrc = "/assets/test.png", about = "Sample Text", email = "1234", phone = "1234" }) {
    return (<div className="flex flex-row mx-16 space-x-8 flex-grow">
        <div className="flex flex-col space-y-8"><Image
            src={imgsrc}
